# 📘 Guia de Modelagem: Ajustar Acessibilidade

## 🎯 Objetivo do Caso de Uso
Personalização da interface para garantir inclusão e conforto visual.

> [!TIP]
> Dica Astah: No diagrama de classe, adicione atributos como 'altoContraste' e 'tamanhoFonte'.
...
3. Arraste as classes para a área de desenho:
   - [ ] Criar **MD_Acessibilidade**.
   - [ ] Criar **MD_Usuarios**.
   - [ ] Criar **Método: salvarConfiguracao()**.
...
3. Desenhe as setas de mensagem seguindo rigorosamente esta ordem:
   - [ ] 1. **Usuario -> MD_Acessibilidade: salvarConfiguracao()**
